...
See [Current State & Capabilities](docs/current_state.md) for a full status breakdown.

---

## Open Problems

The problems we are actively working on — and do not yet have answers to:
...
| [World Modeling](docs/world_modeling.md) | Predictive cognition, continuous forecasting |
| [Dataflows & Developmental Loops](docs/dataflow.md) | How pressure drives representational change |
| [Current State & Capabilities](docs/current_state.md) | Honest status, known limitations |
| [Empirical Validation](docs/benchmarking.md) | What we measure and why |
| [Research Failures & Lessons](docs/lessons.md) | Engineering scars, postmortems, hard lessons |
| [Research Roadmap](docs/roadmap.md) | Development history and long-horizon directions |
| [The Substrate Freeze](docs/substrate_freeze.md) | Why the stable core is frozen |
...
For research discussions, collaboration inquiries, or access requests:

**Roshan Kumar Gupta** — Project Head  
[roshankumargupta.sh@gmail.com](mailto:roshankumargupta.sh@gmail.com)
